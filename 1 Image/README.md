...
### Refer: https://github.com/UntouchedWagons/Ubuntu-CloudInit-Docs
...
**<font color="| ,red,green,yellow|">Script to be run on pve</font>**
...
## Configuring hardware
    ...
    sudo qm set 8001 --ide2 local-lvm:cloudinit
